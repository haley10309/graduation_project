...
<head>
  ...
  <title>3Dmol.js Documentation GLDraw</title>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="GLDraw.ts.html" class="button">View Source</a>
            <span>
                <a href="GLDraw.ts.html">GLDraw.ts</a>, <a href="GLDraw.ts.html#line24">line 24</a>
            </span>
        </p>
    ...
    <h4 class="name" id=".drawCone">
        <a class="href-link" href="#.drawCone">#</a>
        ...
        <span class="code-name">
                ...
                drawCone<span class="signature">(geo, from, to, radius, color)</span><span class="type-signature"></span>
...
<code class="param-type">geometry</code>
...
<code class="param-type">Point</code>
...
<code class="param-type"><a href="Color.html">Color</a></code>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="GLDraw.ts.html" class="button">View Source</a>
            <span>
                <a href="GLDraw.ts.html">GLDraw.ts</a>, <a href="GLDraw.ts.html#line469">line 469</a>
            </span>
        </p>
    ...
    <h4 class="name" id=".drawCylinder">
        <a class="href-link" href="#.drawCylinder">#</a>
        ...
        <span class="code-name">
                ...
                drawCylinder<span class="signature">(geo, from, to, radius, color, fromCap, toCap)</span><span class="type-signature"></span>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="GLDraw.ts.html" class="button">View Source</a>
            <span>
                <a href="GLDraw.ts.html">GLDraw.ts</a>, <a href="GLDraw.ts.html#line233">line 233</a>
            </span>
        </p>
    ...
    <h4 class="name" id=".drawSphere">
        <a class="href-link" href="#.drawSphere">#</a>
        ...
        <span class="code-name">
                ...
                drawSphere<span class="signature">(geo, pos, radius, color, quality)</span><span class="type-signature"></span>
...
<code class="param-type">number</code>
  ...
  <td class="description last"><p>of sphere (default 2, higher increases number of triangles)</p></td>
</tr>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="GLDraw.ts.html" class="button">View Source</a>
            <span>
                <a href="GLDraw.ts.html">GLDraw.ts</a>, <a href="GLDraw.ts.html#line618">line 618</a>
            </span>
        </p>
