...
<head>
  ...
  <title>3Dmol.js Documentation Sinebow</title>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>Sinebow<span class="signature">()</span><span class="type-signature"></span></h2>
        
            <div class="class-description"><p>rainbow gradient with constant saturation, all the way to purple!<br>
Reverse gradients are supported when min&gt;max so that the colors are displayed in reverse order.</p></div>
...
<article>
    ...
    <h4 class="name" id="Sinebow">
        <a class="href-link" href="#Sinebow">#</a>
        
        <span class="code-name">
            
                new Sinebow<span class="signature">()</span><span class="type-signature"></span>
...
<dl class="details">
        ...
        <p class="tag-source">
            ...
            <span>
                <a href="Gradient.ts.html">Gradient.ts</a>, <a href="Gradient.ts.html#line227">line 227</a>
            </span>
        </p>
    ...
    <h5>Example</h5>
        ...
        <pre class="prettyprint"><code>$.get('data/1fas.pqr', function(data){
      ...
      viewer.zoomTo();
        ...
        <dl>
            <dt><a href="Sinebow.html">Sinebow</a></dt>
            <dd></dd>
        </dl>
