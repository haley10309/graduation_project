...
<head>
  ...
  <title>3Dmol.js Documentation Sphere</title>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>Sphere<span class="signature">()</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="Sphere">
        ...
        <span class="code-name">
                ...
                new Sphere<span class="signature">()</span><span class="type-signature"></span>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="WebGL_shapes_Sphere.ts.html" class="button">View Source</a>
            <span>
                <a href="WebGL_shapes_Sphere.ts.html">WebGL/shapes/Sphere.ts</a>, <a href="WebGL_shapes_Sphere.ts.html#line8">line 8</a>
            </span>
        </p>
        ...
        <dl>
            <dt><a href="Sphere.html">Sphere</a></dt>
            <dd></dd>
        </dl>
