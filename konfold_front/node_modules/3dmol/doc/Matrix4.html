...
<head>
  ...
  <title>3Dmol.js Documentation Matrix4</title>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>Matrix4<span class="signature">()</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="Matrix4">
        <a class="href-link" href="#Matrix4">#</a>
        
        <span class="code-name">
            
                new Matrix4<span class="signature">()</span><span class="type-signature"></span>
...
<dl class="details">
        ...
        <p class="tag-source">
            ...
            <span>
                <a href="WebGL_math_math.ts.html">WebGL/math/math.ts</a>, <a href="WebGL_math_math.ts.html#line12">line 12</a>
            </span>
        </p>
        ...
        <dl>
            <dt><a href="Matrix4.html">Matrix4</a></dt>
            <dd></dd>
        </dl>
