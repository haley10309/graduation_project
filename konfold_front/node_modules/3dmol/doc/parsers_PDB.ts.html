...
<head>
  ...
  <title>3Dmol.js Documentation parsers/PDB.ts</title>
...
<div class="top-nav">
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>// parse pdb file from str and create atoms
