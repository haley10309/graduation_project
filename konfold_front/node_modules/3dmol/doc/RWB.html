...
<head>
  ...
  <title>3Dmol.js Documentation RWB</title>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>RWB<span class="signature">()</span><span class="type-signature"></span></h2>
        
            <div class="class-description"><p>Color scheme red to white to blue, for charges<br>
...
<article>
    ...
    <h4 class="name" id="RWB">
        <a class="href-link" href="#RWB">#</a>
        
        <span class="code-name">
            
                new RWB<span class="signature">()</span><span class="type-signature"></span>
...
<dl class="details">
        ...
        <p class="tag-source">
            ...
            <span>
                <a href="Gradient.ts.html">Gradient.ts</a>, <a href="Gradient.ts.html#line52">line 52</a>
            </span>
        </p>
