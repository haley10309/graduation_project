...
<head>
  ...
  <title>3Dmol.js Documentation CustomLinear</title>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>CustomLinear<span class="signature">(min, max, colors)</span><span class="type-signature"></span></h2>
        
            <div class="class-description"><p>Custom linear gradient using user supplied colors.<br>
Reverse gradients are supported when min&gt;max so that the colors are displayed in reverse order.<br>
Midpoints are not supported - color map should be specified to get desired middle color.</p></div>
...
<article>
    ...
    <h4 class="name" id="CustomLinear">
        <a class="href-link" href="#CustomLinear">#</a>
        
        <span class="code-name">
            
                new CustomLinear<span class="signature">(min, max, colors)</span><span class="type-signature"></span>
...
<code class="param-type">Array</code>
  ...
  <td class="description last"><p>Array of colors that will be linearly interpolated between from min to max values.</p></td>
</tr>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="Gradient.ts.html" class="button">View Source</a>
            <span>
                <a href="Gradient.ts.html">Gradient.ts</a>, <a href="Gradient.ts.html#line306">line 306</a>
            </span>
        </p>
    ...
    <h5>Example</h5>
        ...
        <pre class="prettyprint"><code>$3Dmol.get('../test_structs/af.pdb', function(data){
        ...
        <dl>
            <dt><a href="CustomLinear.html">CustomLinear</a></dt>
            <dd></dd>
        </dl>
