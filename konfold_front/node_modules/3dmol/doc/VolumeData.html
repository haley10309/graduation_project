...
<head>
  ...
  <title>3Dmol.js Documentation VolumeData</title>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>VolumeData<span class="signature">(str, format, options)</span><span class="type-signature"></span></h2>
        
            <div class="class-description"><p>$3Dmol.VolumeData stores volumetric data. This includes file parsing<br>
functionality.</p></div>
...
<article>
    ...
    <h4 class="name" id="VolumeData">
        <a class="href-link" href="#VolumeData">#</a>
        
        <span class="code-name">
            
                new VolumeData<span class="signature">(str, format, options)</span><span class="type-signature"></span>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="VolumeData.ts.html" class="button">View Source</a>
            <span>
                <a href="VolumeData.ts.html">VolumeData.ts</a>, <a href="VolumeData.ts.html#line17">line 17</a>
            </span>
        </p>
        ...
        <dl>
            <dt><a href="VolumeData.html">VolumeData</a></dt>
            <dd></dd>
        </dl>
