...
<head>
  ...
  <title>3Dmol.js Documentation parsers/LAMMPSTRJ.ts</title>
...
<div class="top-nav">
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import { assignBonds } from "./utils/assignBonds";
