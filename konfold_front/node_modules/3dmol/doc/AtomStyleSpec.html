...
<head>
  ...
  <title>3Dmol.js Documentation AtomStyleSpec</title>
...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>Atom style specification</p></div>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="GLModel.ts.html" class="button">View Source</a>
            <span>
                <a href="GLModel.ts.html">GLModel.ts</a>, <a href="GLModel.ts.html#line3079">line 3079</a>
            </span>
        </p>
...
<code class="param-type"><a href="CartoonStyleSpec.html">CartoonStyleSpec</a></code>


    </span>

<h4 class="name" id="cartoon">
    <a class="href-link" href="#cartoon">#</a>
...
<div class="description">
    <p>draw cartoon representation of secondary structure</p>
</div>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="GLModel.ts.html" class="button">View Source</a>
            <span>
                <a href="GLModel.ts.html">GLModel.ts</a>, <a href="GLModel.ts.html#line3102">line 3102</a>
            </span>
        </p>
...
<code class="param-type"><a href="ClickSphereStyleSpec.html">ClickSphereStyleSpec</a></code>


    </span>

<h4 class="name" id="clicksphere">
    <a class="href-link" href="#clicksphere">#</a>
...
<div class="description">
    <p>invisible style for click handling only</p>
</div>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="GLModel.ts.html" class="button">View Source</a>
            <span>
                <a href="GLModel.ts.html">GLModel.ts</a>, <a href="GLModel.ts.html#line3107">line 3107</a>
            </span>
        </p>
...
<code class="param-type"><a href="CrossStyleSpec.html">CrossStyleSpec</a></code>


    </span>

<h4 class="name" id="cross">
    <a class="href-link" href="#cross">#</a>
...
<div class="description">
    <p>draw atoms as crossed lines (aka stars)</p>
</div>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="GLModel.ts.html" class="button">View Source</a>
            <span>
                <a href="GLModel.ts.html">GLModel.ts</a>, <a href="GLModel.ts.html#line3087">line 3087</a>
            </span>
        </p>
...
<h4 class="name" id="line">
    <a class="href-link" href="#line">#</a>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="GLModel.ts.html" class="button">View Source</a>
            <span>
                <a href="GLModel.ts.html">GLModel.ts</a>, <a href="GLModel.ts.html#line3082">line 3082</a>
            </span>
        </p>
...
<code class="param-type"><a href="SphereStyleSpec.html">SphereStyleSpec</a></code>


    </span>

<h4 class="name" id="sphere">
    <a class="href-link" href="#sphere">#</a>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="GLModel.ts.html" class="button">View Source</a>
            <span>
                <a href="GLModel.ts.html">GLModel.ts</a>, <a href="GLModel.ts.html#line3097">line 3097</a>
            </span>
        </p>
...
<code class="param-type"><a href="StickStyleSpec.html">StickStyleSpec</a></code>


    </span>

<h4 class="name" id="stick">
    <a class="href-link" href="#stick">#</a>
...
<div class="description">
    <p>draw bonds as capped cylinders</p>
</div>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="GLModel.ts.html" class="button">View Source</a>
            <span>
                <a href="GLModel.ts.html">GLModel.ts</a>, <a href="GLModel.ts.html#line3092">line 3092</a>
            </span>
        </p>
