...
<head>
  ...
  <title>3Dmol.js Documentation WithinSelectionSpec</title>
...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>Within selection object. Used to find the subset of an atom selection that is within<br>
some distance from another atom selection. When added as a field of an <a href="AtomSelectionSpec.html"><code>AtomSelectionSpec</code></a>,<br>
intersects the set of atoms in that selection with the set of atoms within a given<br>
distance from the given <a href="AtomSelectionSpec.html"><code>AtomSelectionSpec</code></a>.</p></div>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="specs.ts.html" class="button">View Source</a>
            <span>
                <a href="specs.ts.html">specs.ts</a>, <a href="specs.ts.html#line230">line 230</a>
            </span>
        </p>
        ...
        <pre class="prettyprint"><code>$3Dmol.download("pdb:2EJ0",viewer,{},function(){
 viewer.setStyle({chain: 'A', within:{distance: 10, sel:{chain: 'B'}}}, {sphere:{}});
 viewer.render();
});// stylizes atoms in chain A that are within 10 angstroms of an atom in chain B</code></pre>
...
<div class="description">
    <p>the distance in angstroms away from the atom selection to include atoms in the parent selection</p>
</div>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="specs.ts.html" class="button">View Source</a>
            <span>
                <a href="specs.ts.html">specs.ts</a>, <a href="specs.ts.html#line243">line 243</a>
            </span>
        </p>
...
<h4 class="name" id="invert">
    <a class="href-link" href="#invert">#</a>
...
<div class="description">
    <p>if set, selects atoms not within distance range for intersection</p>
</div>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="specs.ts.html" class="button">View Source</a>
            <span>
                <a href="specs.ts.html">specs.ts</a>, <a href="specs.ts.html#line248">line 248</a>
            </span>
        </p>
...
<code class="param-type"><a href="AtomSelectionSpec.html">AtomSelectionSpec</a></code>


    </span>

<h4 class="name" id="sel">
    <a class="href-link" href="#sel">#</a>
...
<div class="description">
    <p>the selection of atoms against which to measure the distance from the parent atom selection</p>
</div>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="specs.ts.html" class="button">View Source</a>
            <span>
                <a href="specs.ts.html">specs.ts</a>, <a href="specs.ts.html#line253">line 253</a>
            </span>
        </p>
