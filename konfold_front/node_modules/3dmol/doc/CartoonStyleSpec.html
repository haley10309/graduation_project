...
<head>
  ...
  <title>3Dmol.js Documentation CartoonStyleSpec</title>
...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>A visualization of protein or nucleic acid secondary structure.  Applying this to other molecules will not show anything.<br>
...
of each of these atoms. The backbone color is set from the 'P' atoms ('O5' for the 5' terminus).</p></div>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="glcartoon.ts.html" class="button">View Source</a>
            <span>
                <a href="glcartoon.ts.html">glcartoon.ts</a>, <a href="glcartoon.ts.html#line1033">line 1033</a>
            </span>
        </p>
        ...
        <pre class="prettyprint"><code>$3Dmol.download("pdb:4ZD3",viewer,{},function(){
...
<h4 class="name" id="arrows">
    <a class="href-link" href="#arrows">#</a>
...
<div class="description">
    <p>whether to add arrows showing beta-sheet<br>
directionality; does not apply to trace or ribbon</p>
</div>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="glcartoon.ts.html" class="button">View Source</a>
            <span>
                <a href="glcartoon.ts.html">glcartoon.ts</a>, <a href="glcartoon.ts.html#line1070">line 1070</a>
            </span>
        </p>
...
<div class="description">
    <p>strand color, may specify as 'spectrum' which will apply reversed gradient based on residue number</p>
</div>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="glcartoon.ts.html" class="button">View Source</a>
            <span>
                <a href="glcartoon.ts.html">glcartoon.ts</a>, <a href="glcartoon.ts.html#line1054">line 1054</a>
            </span>
        </p>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="glcartoon.ts.html" class="button">View Source</a>
            <span>
                <a href="glcartoon.ts.html">glcartoon.ts</a>, <a href="glcartoon.ts.html#line1049">line 1049</a>
            </span>
        </p>
...
<div class="description">
    <p>set opacity from 0-1; transparency is set per-chain<br>
with a warning outputted in the event of ambiguity</p>
</div>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="glcartoon.ts.html" class="button">View Source</a>
            <span>
                <a href="glcartoon.ts.html">glcartoon.ts</a>, <a href="glcartoon.ts.html#line1093">line 1093</a>
            </span>
        </p>
...
<h4 class="name" id="ribbon">
    <a class="href-link" href="#ribbon">#</a>
...
<div class="description">
    <p>whether to use constant strand width, disregarding<br>
secondary structure; use thickness to adjust radius</p>
</div>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="glcartoon.ts.html" class="button">View Source</a>
            <span>
                <a href="glcartoon.ts.html">glcartoon.ts</a>, <a href="glcartoon.ts.html#line1064">line 1064</a>
            </span>
        </p>
...
<div class="description">
    <p>style of cartoon rendering (trace, oval, rectangle (default), parabola, edged)</p>
</div>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="glcartoon.ts.html" class="button">View Source</a>
            <span>
                <a href="glcartoon.ts.html">glcartoon.ts</a>, <a href="glcartoon.ts.html#line1059">line 1059</a>
            </span>
        </p>
...
<h4 class="name" id="thickness">
    <a class="href-link" href="#thickness">#</a>
...
<div class="description">
    <p>cartoon strand thickness, default is 0.4</p>
</div>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="glcartoon.ts.html" class="button">View Source</a>
            <span>
                <a href="glcartoon.ts.html">glcartoon.ts</a>, <a href="glcartoon.ts.html#line1082">line 1082</a>
            </span>
        </p>
...
<h4 class="name" id="tubes">
    <a class="href-link" href="#tubes">#</a>
...
<div class="description">
    <p>whether to display alpha helices as simple cylinders;<br>
does not apply to trace</p>
</div>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="glcartoon.ts.html" class="button">View Source</a>
            <span>
                <a href="glcartoon.ts.html">glcartoon.ts</a>, <a href="glcartoon.ts.html#line1076">line 1076</a>
            </span>
        </p>
...
<div class="description">
    <p>cartoon strand width, default is secondary<br>
structure-dependent; does not apply to trace or ribbon</p>
</div>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="glcartoon.ts.html" class="button">View Source</a>
            <span>
                <a href="glcartoon.ts.html">glcartoon.ts</a>, <a href="glcartoon.ts.html#line1087">line 1087</a>
            </span>
        </p>
