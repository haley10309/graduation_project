...
<head>
  ...
  <title>3Dmol.js Documentation WebGL/math/utils/conversionMatrix3.ts</title>
...
<div class="top-nav">
        ...
        <div class="core" id="main-content-wrapper">
            <div class="content">
                <header class="page-title">
                    <p>Source</p>
                    <h1>WebGL/math/utils/conversionMatrix3.ts</h1>
                </header>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>// return conversion matrix given crystal unit cell parameters
