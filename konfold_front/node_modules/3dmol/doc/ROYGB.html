...
<head>
  ...
  <title>3Dmol.js Documentation ROYGB</title>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>ROYGB<span class="signature">()</span><span class="type-signature"></span></h2>
        
            <div class="class-description"><p>rainbow gradient, but without purple to match jmol<br>
...
<article>
    ...
    <h4 class="name" id="ROYGB">
        <a class="href-link" href="#ROYGB">#</a>
        
        <span class="code-name">
            
                new ROYGB<span class="signature">()</span><span class="type-signature"></span>
...
<dl class="details">
        ...
        <p class="tag-source">
            ...
            <span>
                <a href="Gradient.ts.html">Gradient.ts</a>, <a href="Gradient.ts.html#line130">line 130</a>
            </span>
        </p>
        ...
        <dl>
            <dt><a href="ROYGB.html">ROYGB</a></dt>
            <dd></dd>
        </dl>
